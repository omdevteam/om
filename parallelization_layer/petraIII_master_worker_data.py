...
class MasterWorker(object):
    ...
    def __init__(self, map_func, reduce_func, source, monitor_params):
        ...
        piii_data_params = monitor_params['PetraIIIDataParallelizationLayer']
        ...
        self.base_port = piii_data_params['base_port']
        self.priority = 1
        ...
        if self.role == 'worker':
            ...
            self.shots_to_proc = piii_data_params['images_per_file_to_process']
