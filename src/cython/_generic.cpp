...
static PyObject *__pyx_n_s_om_algorithms__generic;
...
static PyObject *__pyx_kp_s_src_cython__generic_pyx;
...
if (!__Pyx_RefNanny) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "om.algorithms._generic")) {
      if (unlikely(PyDict_SetItemString(modules, "om.algorithms._generic", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
