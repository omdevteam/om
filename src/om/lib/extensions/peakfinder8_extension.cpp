...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "src/om/lib/extensions/peakfinder8.hh"
        ],
        "include_dirs": [
            "src/om/lib/extensions",
            "/cds/sw/ds/ana/conda1/inst/envs/ana-4.0.48-py3/lib/python3.9/site-packages/numpy/core/include"
        ],
        "language": "c++",
        "libraries": [
            "stdc++"
...
static void __Pyx_CppExn2PyErr() {
  try {
    if (PyErr_Occurred())
      ; // let the latest Python exn ... through and ignore the current one
    else
      throw;
...
static const char __pyx_k_src_om_lib_extensions_peakfinder[] = "src/om/lib/extensions/peakfinder8_extension.pyx";
...
static PyObject *__pyx_kp_s_src_om_lib_extensions_peakfinder;
...
/* "src/om/lib/extensions/peakfinder8_extension.pyx":70
 * 
 * 
...
static PyObject *__pyx_pf_2om_3lib_21peakfinder8_extension_peakfinder_8(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_max_num_peaks, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_mask, __Pyx_memviewslice __pyx_v_pix_r, int __pyx_v_rstats_num_pix, __Pyx_memviewslice __pyx_v_rstats_pidx, __Pyx_memviewslice __pyx_v_rstats_radius, int __pyx_v_fast, long __pyx_v_asic_nx, long __pyx_v_asic_ny, long __pyx_v_nasics_x, long __pyx_v_nasics_y, float __pyx_v_adc_thresh, float __pyx_v_hitfinder_min_snr, long __pyx_v_hitfinder_min_pix_count, long __pyx_v_hitfinder_max_pix_count, long __pyx_v_hitfinder_local_bg_radius) {
  ...
  /* "src/om/lib/extensions/peakfinder8_extension.pyx":176
 *     """
 ...
 */
  ...
  /* "src/om/lib/extensions/peakfinder8_extension.pyx":178
 *     allocatePeakList(&peak_list, max_num_peaks)
 * 
 *     peakfinder8(&peak_list, &data[0, 0], &mask[0,0], &pix_r[0, 0], rstats_num_pix,             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "src/om/lib/extensions/peakfinder8_extension.pyx":179
 * 
 *     peakfinder8(&peak_list, &data[0, 0], &mask[0,0], &pix_r[0, 0], rstats_num_pix,
 *                 &rstats_pidx[0] if rstats_pidx is not None else NULL,             # <<<<<<<<<<<<<<
 *                 &rstats_radius[0] if rstats_radius is not None else NULL,
 ...
 */
  ...
  /* "src/om/lib/extensions/peakfinder8_extension.pyx":180
 *     peakfinder8(&peak_list, &data[0, 0], &mask[0,0], &pix_r[0, 0], rstats_num_pix,
 *                 &rstats_pidx[0] if rstats_pidx is not None else NULL,
 *                 &rstats_radius[0] if rstats_radius is not None else NULL,             # <<<<<<<<<<<<<<
 *                 fast, asic_nx, asic_ny, nasics_x, nasics_y, adc_thresh,
 ...
 */
  ...
  /* "src/om/lib/extensions/peakfinder8_extension.pyx":196
 ...
 */
  ...
  /* "src/om/lib/extensions/peakfinder8_extension.pyx":198
 *     num_peaks = peak_list.nPeaks
 * 
 *     if num_peaks > max_num_peaks:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_12) {
    ...
    /* "src/om/lib/extensions/peakfinder8_extension.pyx":199
 * 
 *     if num_peaks > max_num_peaks:
 *         num_peaks = max_num_peaks             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "src/om/lib/extensions/peakfinder8_extension.pyx":201
 *         num_peaks = max_num_peaks
 * 
 *     for i in range(0, num_peaks):             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_13; __pyx_t_3+=1) {
    ...
    /* "src/om/lib/extensions/peakfinder8_extension.pyx":203
 *     for i in range(0, num_peaks):
 * 
 *         peak_x = peak_list.peak_com_x[i]             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "src/om/lib/extensions/peakfinder8_extension.pyx":204
 * 
 *         peak_x = peak_list.peak_com_x[i]
 *         peak_y = peak_list.peak_com_y[i]             # <<<<<<<<<<<<<<
 *         peak_index = peak_list.peak_com_index[i]
 ...
 */
    ...
    /* "src/om/lib/extensions/peakfinder8_extension.pyx":205
 *         peak_x = peak_list.peak_com_x[i]
 *         peak_y = peak_list.peak_com_y[i]
 *         peak_index = peak_list.peak_com_index[i]             # <<<<<<<<<<<<<<
 *         peak_value = peak_list.peak_totalintensity[i]
 ...
 */
    ...
    /* "src/om/lib/extensions/peakfinder8_extension.pyx":206
 *         peak_y = peak_list.peak_com_y[i]
 *         peak_index = peak_list.peak_com_index[i]
 *         peak_value = peak_list.peak_totalintensity[i]             # <<<<<<<<<<<<<<
 *         peak_npix = peak_list.peak_npix[i]
 ...
 */
    ...
    /* "src/om/lib/extensions/peakfinder8_extension.pyx":207
 *         peak_index = peak_list.peak_com_index[i]
 *         peak_value = peak_list.peak_totalintensity[i]
 *         peak_npix = peak_list.peak_npix[i]             # <<<<<<<<<<<<<<
 *         peak_maxi = peak_list.peak_maxintensity[i]
 ...
 */
    ...
    /* "src/om/lib/extensions/peakfinder8_extension.pyx":208
 *         peak_value = peak_list.peak_totalintensity[i]
 *         peak_npix = peak_list.peak_npix[i]
 *         peak_maxi = peak_list.peak_maxintensity[i]             # <<<<<<<<<<<<<<
 *         peak_sigma = peak_list.peak_sigma[i]
 ...
 */
    ...
    /* "src/om/lib/extensions/peakfinder8_extension.pyx":209
 *         peak_npix = peak_list.peak_npix[i]
 *         peak_maxi = peak_list.peak_maxintensity[i]
 *         peak_sigma = peak_list.peak_sigma[i]             # <<<<<<<<<<<<<<
 *         peak_snr = peak_list.peak_snr[i]
 ...
 */
    ...
    /* "src/om/lib/extensions/peakfinder8_extension.pyx":210
 *         peak_maxi = peak_list.peak_maxintensity[i]
 *         peak_sigma = peak_list.peak_sigma[i]
 *         peak_snr = peak_list.peak_snr[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "src/om/lib/extensions/peakfinder8_extension.pyx":212
 *         peak_snr = peak_list.peak_snr[i]
 * 
 *         peak_list_x.push_back(peak_x)             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "src/om/lib/extensions/peakfinder8_extension.pyx":213
 * 
 *         peak_list_x.push_back(peak_x)
 *         peak_list_y.push_back(peak_y)             # <<<<<<<<<<<<<<
 *         peak_list_index.push_back(peak_index)
 ...
 */
    ...
    /* "src/om/lib/extensions/peakfinder8_extension.pyx":214
 *         peak_list_x.push_back(peak_x)
 *         peak_list_y.push_back(peak_y)
 *         peak_list_index.push_back(peak_index)             # <<<<<<<<<<<<<<
 *         peak_list_value.push_back(peak_value)
 ...
 */
    ...
    /* "src/om/lib/extensions/peakfinder8_extension.pyx":215
 *         peak_list_y.push_back(peak_y)
 *         peak_list_index.push_back(peak_index)
 *         peak_list_value.push_back(peak_value)             # <<<<<<<<<<<<<<
 *         peak_list_npix.push_back(peak_npix)
 ...
 */
    ...
    /* "src/om/lib/extensions/peakfinder8_extension.pyx":216
 *         peak_list_index.push_back(peak_index)
 *         peak_list_value.push_back(peak_value)
 *         peak_list_npix.push_back(peak_npix)             # <<<<<<<<<<<<<<
 *         peak_list_maxi.push_back(peak_maxi)
 ...
 */
    ...
    /* "src/om/lib/extensions/peakfinder8_extension.pyx":217
 *         peak_list_value.push_back(peak_value)
 *         peak_list_npix.push_back(peak_npix)
 *         peak_list_maxi.push_back(peak_maxi)             # <<<<<<<<<<<<<<
 *         peak_list_sigma.push_back(peak_sigma)
 ...
 */
    ...
    /* "src/om/lib/extensions/peakfinder8_extension.pyx":218
 *         peak_list_npix.push_back(peak_npix)
 *         peak_list_maxi.push_back(peak_maxi)
 *         peak_list_sigma.push_back(peak_sigma)             # <<<<<<<<<<<<<<
 *         peak_list_snr.push_back(peak_snr)
 ...
 */
    ...
    /* "src/om/lib/extensions/peakfinder8_extension.pyx":219
 *         peak_list_maxi.push_back(peak_maxi)
 *         peak_list_sigma.push_back(peak_sigma)
 *         peak_list_snr.push_back(peak_snr)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "src/om/lib/extensions/peakfinder8_extension.pyx":221
 *         peak_list_snr.push_back(peak_snr)
 * 
 *     freePeakList(peak_list)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "src/om/lib/extensions/peakfinder8_extension.pyx":223
 *     freePeakList(peak_list)
 * 
 *     return (peak_list_x, peak_list_y, peak_list_value, peak_list_index,             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "src/om/lib/extensions/peakfinder8_extension.pyx":224
 * 
 *     return (peak_list_x, peak_list_y, peak_list_value, peak_list_index,
 *             peak_list_npix, peak_list_maxi, peak_list_sigma, peak_list_snr)             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_src_om_lib_extensions_peakfinder, __pyx_k_src_om_lib_extensions_peakfinder, sizeof(__pyx_k_src_om_lib_extensions_peakfinder), 0, 0, 1, 0},
 ...
 */
  ...
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(17, 0, 36, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_om_lib_extensions_peakfinder, __pyx_n_s_peakfinder_8, 70, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 70, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  /* "src/om/lib/extensions/peakfinder8_extension.pyx":28
 ...
 */
  ...
  /* "src/om/lib/extensions/peakfinder8_extension.pyx":1
