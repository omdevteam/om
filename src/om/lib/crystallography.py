...
"""
Classes and functions for processing of crystallography data.
...
class CrystallographyPlots:
    ...
    def __init__(
        ...
        *,
        ...
        This class stores all the information needed to generate and update a set of
        ...
        Separate hit tate history plots for dark and pumped events can be generated for
        pump-probe experiment.

        After the class has been initialized, data event information can be added to
        it, and the updated plots can be retrieved and sent to external programs for
        visualization.
    ...
    def update_plots(
        ...
        *,
        ...
        data plots generated by this class, assuming that all the provided information
        refers to the same data event.
        ...
        * A 2D array storing the pixel values of the virtual powder pattern plot.

        * A 2D array storing the pixel values of the peakogram plot.
        ...
        * A list storing the x visualization coordinates of all the Bragg peaks
          identified in the data event provided to the update function. The coordinates
          refers to an array storing the assembled detector image, with the origin in
          the top left corner of the image.

        * A list storing the y visualization coordinates of all the Bragg peaks
          identified in the data event provided to the update function. The coordinates
          refers to an array storing the assembled detector image, with the origin in
          the top left corner of the image.
        ...
        Arguments:
            ...
            peak_list: Information about the Bragg peaks identified in the detector
                data frame attached to the provided data event.

            frame_is_hit: Whether the data event has been labelled a hit, or not.
            ...
            optical_laser_active: Whether the optical laser is active or not in the
                ...
                experiments, and ignored otherwise.
    ...
    def clear_plots(self) -> None:
        """
        Resets the crystallography data plots.
        ...
        if self._crystallography_parameters.pump_probe_experiment is True:
            self._hit_rate_running_window_dark = deque(
                [0.0] * self._running_average_window_size,
                maxlen=self._running_average_window_size,
            )
