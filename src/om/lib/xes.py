...
class XesAnalysisAndPlots:
    ...
    def __init__(self, *, parameters: XesParameters, time_resolved: bool) -> None:
        ...
        camera data frames, and analyze them. Additionally, the class stores all the
        information needed to generate and update plots that summarize the state of an
        X-ray Emission Spectroscopy experiment. Specifically the class generates plots
        showing the cumulative sum of all observed energy spectra, in raw and smoothed
        form, and a plot showing the cumulative sum of all recorded detector data
        frames.

        For pump probe experiments, this class can compute separate spectral plots for
        pumped and dark events, and show their difference.
        ...
        self._spectra_cumulative_sum: NDArray[numpy.float64 | numpy.int_] | None = None
        self._spectra_cumulative_sum_smoothed: NDArray[numpy.float64] | None = None

        self._cumulative_2d: NDArray[numpy.float64 | numpy.int_] | None = None
        self._cumulative_2d_pumped: NDArray[numpy.float64 | numpy.int_] | None = None

        self._cumulative_2d_dark: NDArray[numpy.float64 | numpy.int_] |  None = None
    ...
    def update_plots(
        self,
        *,
        detector_data: NDArray[numpy.float64 | numpy.int_],
        optical_laser_active: bool,
    ) -> tuple[
        NDArray[numpy.float64 | numpy.int_] | None,
        ...
        to display the plots in a graphical interface, in the format of a tuple
        ...
        * For pump-probe experiments, the cumulative sum of all observed energy spectra
          for events with an active optical laser. For non pump-probe experiments, this
        ...
        * For pump-probe experiments, the the difference between the cumulative sum of
          ...
          optical laser.  For non pump-probe experiments, this
          entry is just the value None.
        ...
        Arguments:
            ...
            optical_laser_active: Whether the optical laser is active or not in the
                ...
                information is only relevant for pump-probe experiments, and it is
                ignored otherwise.
        ...
        cumulative_xes: dict[str, NDArray[numpy.float64]] = (
        ...
        spectra_cumulative_sum_pumped: NDArray[numpy.float64] | None = None
        spectra_cumulative_sum_dark: NDArray[numpy.float64] | None = None
        spectra_cumulative_sum_difference: NDArray[numpy.float64] | None = None
        ...
        if self._time_resolved:
            ...
            cumulative_xes_pumped: dict[str, NDArray[numpy.float64]] = (
            ...
            # calculate spectrum from cumulative 2D images
            cumulative_xes_dark: dict[str, NDArray[numpy.float64]] = (
                self._energy_spectrum_retrieval.calculate_spectrum(
