...
and aggregated data in SWAXS experiments.
"""
...
class SwaxsGui(OmGuiBase):
    ...
    def __init__(self, *, url: str) -> None:
        ...
        This class implements a graphical user interface for SWAXS
        ...
        SWAXS when it is tagged with the 'omdata' label. The data must
...
def main(
    *,
    ...
    """
    OM Graphical User Interface for SWAXS. This program must connect to a
    running OnDA Monitor for SWAXS. If the monitor broadcasts the necessary
    ...
    """
    # This function is turned into a script by the Typer library. The docstring
