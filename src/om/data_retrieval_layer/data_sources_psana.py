...
def _get_psana_epics_name(
    *, source_protocol_name: str, monitor_parameters: MonitorParams
    ...
    # the string "psana-"".
    if source_protocol_name.startswith("psana-"):
        detector_name: str = source_protocol_name.split("psana-")[1]
    else:
        detector_name = monitor_parameters.get_parameter(
            group="data_retrieval_layer",
            parameter=f"psana_{source_protocol_name}_epics_name",
            parameter_type=str,
        )
...
def _get_psana_detector_name(
    *, source_protocol_name: str, monitor_parameters: MonitorParams
    ...
    if source_protocol_name.startswith("psana-"):
        ...
        detector_name = monitor_parameters.get_parameter(
            group="data_retrieval_layer",
            parameter=f"psana_{source_protocol_name}_name",
            required=True,
            parameter_type=str,
        )
    return detector_name
...
def _get_psana_data_retrieval_function(
    ...
    *,
    ...
    detector_name: str = _get_psana_detector_name(
        source_protocol_name=source_protocol_name, monitor_parameters=monitor_parameters
    )
...
class CspadPsana(drl_protocol.OmDataSource):
    """
    ...
    def __init__(
        ...
        *,
        ...
        psana name matches the `psana_{source_protocol_name}_name` entry in OM's
        ...
        `source_protocol_name` argument, by prefixing it with the string "psana-". The
        detector data frame can be retrieved in calibrated or non-calibrated form,
        depending on the value of the `{source_protocol_name}_calibration` entry in the
    ...
    def initialize_data_source(self) -> None:
        ...
        whose psana name matches the entry `psana_{source_protocol_name}_name` in OM's
        `data_retrieval_layer` configuration parameter group, or for the detector with
        a given psana name, if the `source_protocol_name` argument has the format
    ...
    def get_data(
        ...
        value of the `{source_protocol_name}_calibration` entry in OM's `data_retrieval_layer`
...
class Epix10kaPsana(drl_protocol.OmDataSource):
    """
    See documentation of the `__init__` function.
    """
    ...
    def initialize_data_source(self) -> None:
        ...
        This function initializes the psana Detector interface for the detector
        whose psana name matches the `psana_{source_protocol_name}_name` entry in OM's
        `data_retrieval_layer` configuration parameter group, or for the detector with
        a given psana name, if the `source_protocol_name` argument has the format
        `psana-{psana detector name}`.
        """
...
class Jungfrau4MPsana(drl_protocol.OmDataSource):
    """
    See documentation of the `__init__` function.
    """
    ...
    def initialize_data_source(self) -> None:
        ...
        This function initializes the psana Detector interface for the detector
        whose psana name matches the `psana_{source_protocol_name}_name` entry in the
        OM's `data_retrieval_layer` configuration parameter group, or for the detector
        with a given psana name, if the `source_protocol_name` argument has the format
        `psana-{psana detector name}`.
        """
        self._data_retrieval_function: Callable[
            [Any], Any
    ...
    def get_data(
        ...
        provided event. It returns the frame as a 2D array storing pixel information.
        Data is retrieved in calibrated or non-calibrated form depending on the
        value of the `{source_protocol_name}_calibration` entry in OM's
...
class Epix100Psana(drl_protocol.OmDataSource):
    """
    See documentation of the `__init__` function.
    """
...
class RayonixPsana(drl_protocol.OmDataSource):
    """
    See documentation of the `__init__` function.
    """
    ...
    def __init__(
        ...
        *,
        ...
        `data_retrieval_layer` configuration parameter group. However, it is also
        possible to provide the psana name of the detector directly in the
        `source_protocol_name` argument, by prefixing it with the string "psana-".
...
class OpalPsana(drl_protocol.OmDataSource):
    """
    See documentation of the `__init__` function.
    """
    ...
    def __init__(
        ...
        *,
        ...
        matches the `psana_{source_protocol_name}_name` entry in OM's `data_retrieval_layer`
        configuration parameter group. However, it is also possible to provide the
        psana name of the camera directly in the `source_protocol_name` argument, by
...
class AcqirisPsana(drl_protocol.OmDataSource):
    """
    See documentation of the `__init__` function.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Acqiris detector whose psana name matches the `psana_{source_protocol_name}_name`
        ...
        the `source_protocol_name` argument, by prefixing it with the string "psana-".
...
class AssembledDetectorPsana(drl_protocol.OmDataSource):
    """
    See documentation of the `__init__` function.
    """
    ...
    def __init__(
        ...
        *,
        ...
        for the detector whose psana name matches the `psana_{source_protocol_name}_name`
        entry in OM's `data_retrieval_layer` configuration parameter group. However, it
...
class Wave8Psana(drl_protocol.OmDataSource):
    """
    See documentation of the `__init__` function.
    """
    ...
    def __init__(
        ...
        *,
        ...
        matches the `psana_{source_protocol_name}_name` entry in OM's
        `data_retrieval_layer` configuration parameter group. However, it is also
...
class TimestampPsana(drl_protocol.OmDataSource):
    """
    See documentation of the `__init__` function.
    """
...
class EventIdPsana(drl_protocol.OmDataSource):
    """
    See documentation of the `__init__` function.
    """
...
class EpicsVariablePsana(drl_protocol.OmDataSource):
    """
    See documentation of the `__init__` function.
    """
    ...
    def __init__(
        ...
        *,
        ...
        name matches the `psana_{source_protocol_name}_name` entry in OM's
        `data_retrieval_layer` configuration parameter group. However, it is also
    ...
    def initialize_data_source(self) -> None:
        ...
        psana name matches the `psana_{source_protocol_name}_name` entry in the
        OM's `data_retrieval_layer` configuration parameter group, or for the Epics
        variable with a given psana name, if the `source_protocol_name` argument has the
...
class BeamEnergyPsana(drl_protocol.OmDataSource):
    """
    See documentation of the `__init__` function.
    """
...
class EvrCodesPsana(drl_protocol.OmDataSource):
    """
    See documentation of the `__init__` function.
    """
...
class LclsExtraPsana(drl_protocol.OmDataSource):
    """
    See documentation of the `__init__` function.
    """
