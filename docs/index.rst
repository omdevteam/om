...
**OnDA** (\ **On**\ line \ **D**\ ata \ **A**\ nalysis) is a software framework for
the development of programs that can monitor of X-ray imaging experiments in real-time,
and also a set of ready-to-go monitoring programs.
