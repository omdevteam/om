...
streakFinder_constantArguments_t *precomputeStreakFinderConstantArguments(
        const streakFinder_accuracyConstants_pythonWrapper_t streakFinder_accuracyConstants,
        const detectorRawFormat_t detectorRawFormat,
        const detectorGeometryMatrix_pythonWrapper_t detectorGeometryMatrix_python,
        const uint8_t *mask)
{
    ...
    *detectorRawFormat_heap = detectorRawFormat;
    ...
    streakFinder_constantArguments_t *streakFinderConstantArguments_heap = new streakFinder_constantArguments_t();

    streakFinderConstantArguments_heap->accuracyConstants = (void*) accuracyConstants_heap;
    streakFinderConstantArguments_heap->detectorRawFormat = (void*) detectorRawFormat_heap;
    streakFinderConstantArguments_heap->detectorPositions = (void*) detectorPositions_heap;
    streakFinderConstantArguments_heap->streakFinder_precomputedConstant = (void*) streakFinder_precomputedConstants_heap;

    return streakFinderConstantArguments_heap;
