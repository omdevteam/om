...
Exports:
    ...
    Classes:
        ...
        FibersHitViewer: a class implementing a hit viewer for OnDA
            Fibers.
"""
...
class FibersHitViewer(gui.OndaGui):
    ...
    the detector frames that it receives from the OnDA monitor.
    Receives data sent by the OnDA monitor when they are tagged with the
    'ondarawdata' tag.
    """
    def __init__(self,
                 geometry,
                 ...
                 pub_port):
        """
        Initialize the FibersHitViewer class.
