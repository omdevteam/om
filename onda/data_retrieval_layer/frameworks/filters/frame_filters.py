...
Filters to skip the processing of single frames according to various criteria.
"""
...
class NullFrameFilter(object):
    ...
    def should_reject(self, num_frames_in_event, frame_offset):
        ...
        For this null frame filter, this function never rejects frames.
        ...
        Returns:
            ...
            bool: True if the frame should be rejected. False if the frame should be
            processed.
        """
        del num_frames_in_event
        del frame_offset
        return False
...
class IndexBasedFrameFilter(object):
    ...
    This filter looks at the index of the frame within the event, and rejects events
    whose index is included in a list provided by the user.
    """
