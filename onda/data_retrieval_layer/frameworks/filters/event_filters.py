...
class NullEventFilter(object):
    ...
    def should_reject(self, event):
        ...
        For this null event filter, this function never rejects events.
        ...
        Returns:
            ...
            bool: True if the event should be rejected. False if the event should be
            processed.
        """
        del event
...
class AgeEventFilter(object):
    ...
    This filter rejects events whose 'age' (the time between the data collection and
    the moment OnDA receives the data) is higher than a predefined threshold.
    """
    ...
    def __init__(self, monitor_params):
        ...
        Args:
            ...
            monitor_params (MonitorParams): a
                ...
                monitor parameters from the configuration file.
        """
        # Reads the rejection threshold from the configuration file and stores it in
        # an attribute.
        ...
        if rejection_threshold:
            ...
            # If no threshold is provided, uses a very high threshold (more than 300
            # years).
...
class ExtensionEventFilter(object):
    ...
    This filter looks at the file from which an event has been retrieved (when
    applicable), extracts its extension and compares it to the list of extensions used
    with files written by the detector(s) being used. It rejects the event if the file
    ...
    def __init__(self, monitor_params):
        ...
        Args:
            ...
            monitor_params (MonitorParams): a
                ...
                monitor parameters from the configuration file.
        """
        self._file_extensions = dynamic_import.get_file_extensions(monitor_params)
