...
def get_peakfinder8_info():
    """
    Peakfinder8 info for the Jungfrau 1M detector at LCLS.

    Retrieves the peakfinder8 information matching the data format used by the
...
def detector_data(event, data_extraction_func_name):
    """
    One frame of Jungfrau 1M detector data at LCLS.

    Extracts one frame of Jungfrau 1M detector data from an event retrieved at the
    LCLS facility.
