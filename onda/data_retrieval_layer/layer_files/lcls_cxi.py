...
Classes and functions used to retrieve and extract data at the CXI beamline of the
LCLS facility.
"""
...
from onda.data_retrieval_layer.data_sources import cspad_psana
...
globals()["get_peakfinder8_info"] = cspad_psana.get_peakfinder8_info
...
globals()["detector_data"] = functools.partial(
    cspad_psana.detector_data, data_extraction_func_name="detector_data"
)
