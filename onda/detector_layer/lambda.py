...
"""
Functions and classes for the processing of data from the Lambda detector.
...
def get_peakfinder8_detector_info_hidra():
    """
...
def filename_and_frame_index_hidra(event):
    ...
    FnameAndFrameIndex = collections.namedtuple(
    ...
    # index of the current frame and return the tuple.
...
get_peakfinder8_info_filelist = get_peakfinder8_detector_info_hidra
