...
class MainFrame(QtGui.QMainWindow):
    ...
    def __init__(self, monitor_params, rec_ip, rec_port):
        ...
        self._adc_threshold_lineedit.setText(str(self._monitor_params['Peakfinder8PeakDetection']['adc_threshold']))
        ...
        self._min_snr_lineedit.setText(str(self._monitor_params['Peakfinder8PeakDetection']['minimum_snr']))
        ...
        self._min_pixel_count_lineedit.setText(str(self._monitor_params['Peakfinder8PeakDetection']['min_pixel_count']))
        ...
        self._max_pixel_count_lineedit.setText(str(self._monitor_params['Peakfinder8PeakDetection']['max_pixel_count']))
        ...
        self._local_bg_radius_lineedit.setText(str(self._monitor_params['Peakfinder8PeakDetection']['local_bg_radius']))
